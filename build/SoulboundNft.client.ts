...
import {InstantiateMsg, ExecuteMsg, QueryMsg, MigrateMsg, AllNftInfoResponseForEmpty, OwnerOfResponse, NftInfoResponseForEmpty, TokensResponse, ConfigResponse, ContractInfoResponse, MinterResponse, SoulboundNftInfoResponse, MetadataResponse, NumTokensResponse} from "./SoulboundNft.types";
export interface SoulboundNftReadOnlyInterface {
  ...
  nftInfo: ({
    ...
    tokenId: string;
  }) => Promise<SoulboundNftInfoResponse>;
  allNftInfo: ({
    tokenId
  }: {
    tokenId: string;
